...
export const respondCustomSuccess = async (res, data) => {
	res.status(200).send(data);
};

export const respondObjectNotFound = async (res, data) => {
	res.status(404).send({
...
export const respondUnauthorized = async (res, data) => {
	res.status(401).send({
...
export const respondNotAllowed = async (res, data) => {
	res.status(403).send({
		message: 'Not allowed',
		details: data,
	});
...
export const respondApiErrorByProductField = async (
	res,
	statusCode,
	message,
	details,
