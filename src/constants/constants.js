const responseMessages = {
	EN: {
		...
		DEACTIVATE_FAILURE_MESSAGE:
			'Could not deactivate. Please try again later',
		...
		MERCHANT_SETTINGS_UPDATE_SUCCESS:
		...
		PAYMENT_REQUEST_FETCH_FAILURE:
			'PPayment request could not be  fetched.',
		...
		PAYMENT_REQUEST_CANCEL_SUCCESS:
		...
		ADMIN_USER_DETAIL_SUCCESS_MESSAGE:
			'Admin user detail listed successfully',
		...
		//CMS NOTIFICATIONS
		NOTIFICATIONS_LISTED_SUCCESS_MESSAGE:
		...
		EMAIL_TEMPLATE_LIST_SUCCESS_MESSAGE:
			'Email templates listed successfully.',
		...
		CHARITY_PARTNER_UPDATE_SUCCESS:
			'Charity merchant updated successfully.',
		// PAYMENTS
		...
		PAYMENT_METHOD_DEFAULT_SUCCESS:
			'Payment Method made default successfully.',
		...
		FETCH_ALL_FUNDRAISER_SUCCESS:
			'Got all fundraiser listings successfully',
		...
		REQUEST_TEMPLATE_CREATE_SUCCESS:
			'Request template created successfully.',
		REQUEST_TEMPLATE_NOT_FOUND: 'Request template not found.',
		REQUEST_TEMPLATE_CREATE_FAILURE:
			'Request template could not be created.',
		REQUEST_TEMPLATE_FETCH_FAILURE:
			'Request template could not be fetched.',
		REQUEST_TEMPLATE_FETCH_SUCCESS:
			'Request template fetched successfully.',
		REQUEST_TEMPLATE_UPDATE_SUCCESS:
			'Request template updated successfully.',
		REQUEST_TEMPLATE_UPDATE_FAILURE:
			'Request template could not be updated.',
		REQUEST_TEMPLATE_CANCEL_SUCCESS:
			'Request template cancelled successfully.',
